...
public static class SeedUtil {
    ...
    public static List<string> GetImageUrls(string type = "") {
        var imageMap = new Dictionary<List<string>, List<string>>() {
            ...
            {
                new List<string> { "artworks", "arts_centre", "artwork" },
                new List<string> {
            ...
            {
                new List<string> { "cafe", "restaurant", "fast_food" },
                new List<string> {
            ...
            {
                new List<string> { "hotel", "guesthouse", "hostel" },
                new List<string> {
            ...
            {
                new List<string> { "park", "picnic_site", "playground" },
                new List<string> {
            ...
            {
                new List<string> { "hospital", "clinic" },
                new List<string> {
